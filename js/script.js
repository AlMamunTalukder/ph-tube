                ...
                <div class="card-body">
                    ...
                    <div class="card-footer  justify-between mt-8">  
                        ...
                        <div class="flex">
                            ...
                            <div><h3>${videos?.others.views?videos.others.views:""} Views</h3></div>                     
                            </div>
                        </div>                        
...
const sortVideosByView = () => {
    ...
    cardArray.sort((a, b) => {
      const viewsA = parseInt(a.querySelector("h3").textContent) || 0;
      const viewsB = parseInt(b.querySelector("h3").textContent) || 0;
